  ...
  return (
    <section className={`${styles.aboutMeWrapper}`}>
      ...
      <div className={styles.aboutMeTextWrapper}>
        <h4 className="">
        Hello! I'm a Java developer with expertise in Spring and SQL. I have a strong foundation in object-oriented programming, a deep understanding of UML, and proficiency in implementing hexagonal architecture. My focus is on creating robust and maintainable applications.
        </h4>
      </div>
